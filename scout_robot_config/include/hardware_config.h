...
// #define USE_ROS_RF
    ...
    //#define LFH_INV true
    #define LFH_INV false                 //original
    //#define LFU_INV false               //original
    #define LFU_INV true
    #define LFL_INV true
    //#define LFL_INV false               //(original)

    #define RFH_INV false
    #define RFU_INV false
    //#define RFL_INV false 
    //#define RFU_INV true              //(original)
    #define RFL_INV true              //(original)
    

    //#define LHH_INV false 
    #define LHH_INV true              //original 
    #define LHU_INV false
    //#define LHL_INV true   
    #define LHL_INV false               //(original)
